...
// ฟังก์ชันสร้าง Modal เพิ่มสินค้า (แก้ไขปัญหา \n ใน Placeholder เรียบร้อย)
function buildAddProductModal() {
    ...
    // ตัวเลือกเสริม ไม่บังคับกรอก (setRequired: false)
    ...
    // ตัวเลือกเสริม ไม่บังคับกรอก (ข้อความ Placeholder ห้ามมี \n)
    const linkAndImage = new TextInputBuilder()
        .setCustomId('prod_links')
        .setLabel("ลิงก์ไฟล์ (บรรทัด1) และ ลิงก์รูป (บรรทัด2) ถ้ามี")
        .setPlaceholder("บรรทัดที่ 1: ลิงก์ดาวน์โหลดสินค้า | บรรทัดที่ 2: ลิงก์รูปภาพตัวอย่าง")
...
// ---------------------------------------------------------
// ระบบ Interaction และการทำงานหลัก (ครอบ try-catch กันค้าง)
// ---------------------------------------------------------
